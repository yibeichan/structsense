...
class StructSenseFlow(Flow):
    ...
    async def align_structured_information(self, extracted_result):
        ...
        alignment_result = alignment_crew.kickoff(inputs={
            "extracted_structured_information": processed_result,
